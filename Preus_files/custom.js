...
$(function() {
  ...
  $navigation.find("> .nav-item > .nav-link").each(function(e) {
    ...
    $(this).text("");
    $(this)
      .append("<span>" + firstLetter + "</span>")
      .append("<span class='ts-hidden'>" + hiddenLetters + "</span>");
    $(this)
      .find(".ts-hidden")
      .css("transition-delay", e * 50 + "ms");
  });
  ...
  $("[data-ts-delay]").each(function() {
    $(this)
      .css("transition-delay", $(this).attr("data-ts-delay"))
      .css("animation-delay", $(this).attr("data-ts-delay"));
  });
